    ...
    <div className="min-h-screen bg-gray-950 text-white flex" dir="rtl">
      <aside className="w-64 bg-gray-900 border-l border-white/10 flex flex-col fixed h-full right-0">
        ...
        <div className="p-4 border-t border-white/10">
          <Link href={'/'} title="هدایت به صفحه اصلی" className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm text-white/50 hover:text-red-400 hover:bg-red-400/10 transition-all w-full">
            <MdLogout size={18} />
            خروج از حساب
          </Link>
        </div>
