...
const AddProductModal = () => {
  ...
  return (
    <div dir="rtl">
      <button
        type="button"
        className="inline-flex items-center gap-2 rounded-2xl bg-linear-to-l from-sky-500 to-indigo-500 px-4 py-2.5 text-sm font-medium text-white shadow-sm transition-all hover:shadow-md"
              ...
              <section className="rounded-3xl border border-slate-200 bg-slate-50/60 p-5">
                ...
                <div className="mt-4">
                  ...
                  <ReactQuill
                    ...
                    onChange={(val) =>
                      setValue("product_description", val, { shouldValidate: true })
                    }
